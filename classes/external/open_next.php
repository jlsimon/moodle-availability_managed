...
class open_next extends external_api {
    ...
    public static function execute(int $courseid, string $scope, int $scopeid): array {
        ...
        $section = (new progression_service())->open_next(
            $params['courseid'],
            $params['scope'],
            $params['scopeid'],
            (int) $USER->id
        );
        return ['opened' => $section !== null, 'sectionname' => $section['name'] ?? ''];
    }
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            'opened' => new external_value(PARAM_BOOL),
